...
***REMOVED***public void Insert(string id, string name, string email, string joinDate)
***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED***public void DisplayData()
***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED***public void DeleteData()
***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED***
***REMOVED***public void Update(string id, string? name, string? email, string? joinDate)
***REMOVED******REMOVED***
***REMOVED***
...
***REMOVED***public void Delete(string id)
***REMOVED******REMOVED***
***REMOVED***
